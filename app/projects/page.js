...
const page = () => {
  return (
    <div className='my-14 w-6xl flex flex-wrap flex-row justify-center'>
        <div className=' m-6 p-4 h-96 w-80 backdrop-blur-xl hover:scale-110 hover:ease-in duration-300 rounded-sm border-4  border-slate-50 hover:border-slate-400 hover:shadow-black hover:shadow-2xl'>
        <div>
        ...
        <div className='p-4 m-6 h-96 w-80 backdrop-blur-xl hover:scale-110 hover:ease-in duration-300 rounded-sm border-4  border-slate-50 hover:border-slate-400 hover:shadow-black hover:shadow-2xl'>
        <div>
        <Image height={500} width={500} src={vidweb}/>
        </div>
        <div className='overflow-y-scroll h-3/5 scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-gray-300 flex flex-col text-hereis p-4'>
